...
<?php
	...
	echo	$User_name=$_COOKIE['Username'];
	}
			...
			<div class="container">
				<div class="nav navbar-nav header-two-left">
					<ul>
						...
						?>
						<li><p><a href="register.php">Register </a> Or <a href="../login.php">LogIn</a></p></li>
							...
							<?php  }else{ ?>
									...
									<?php	
											...
											if(mysql_num_rows($check_user_product)==1){
												...
												?>
												<a href="../profile/productinformation.php" title="Click here to view cart">
													<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
													<span>[ 1 ]</span>
												</a>	
												...
												<a href="../profile" title="Click here to view cart">
													<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
													<span></span> (<span> 0 </span>)
												</a>	
