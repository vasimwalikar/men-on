          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="#" class="active"></i>Payment Transactions For pit shop</a></li>
				<li><a href="rb_transactions.php"></i>Payment Transactions For Race Bucks </a></li>
		 ...
		 <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">              
              <div class="templatemo-content-widget pink-bg">
                ...
                <h2 class="text-uppercase margin-bottom-10">A List Of Payment Transactions For <b>Pit Shop</b>.</h2>
				<?php
					...
					$transactions = mysql_query("SELECT registration.username, products_payment_gateway.products_transaction_id,products_payment_gateway.reference_id, products_payment_gateway.amount, products_payment_gateway.product_booked FROM products_payment_gateway INNER JOIN registration ON products_payment_gateway.reg_id = registration.id");
				...
				<tr><th>Id</th>
					...
					<?php
						...
						while ($trans = mysql_fetch_array($transactions)) {
							...
							echo '<td>'.$trans['reference_id'].'</td>';
							echo '<td>'.$trans['username'].'</td>';
							echo '<td>'.$trans['amount'].'</td>';
							echo '<td>'.$trans['product_booked'].'</td>';
							echo '</tr>';
						}
					?>
              </table>    
