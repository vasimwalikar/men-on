	...
	<!---------------------end------------------------>
      ...
      <!-- Main content --> 
				<?php
					...
					$races = mysql_query("SELECT * FROM racelog WHERE ");
            ...
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
			   <li><a href="manage-users.php">active users</a></li>
			    <li><a href="non_active_users.php" class="active">non active users</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
			  ...
			  <h3 style="color:green;">Users who haven't played yet</h3><br/><br/>
               <span style="color:#777777"><li>Users who have not yet activated their account are shown in grey.</li></span>          
            </div>
			...
			<table class="overflow-y">
				...
				<tbody>
					...
					//////////////////////////END////////////////////////
						...
						$registered_users = mysql_query("SELECT * FROM registration WHERE createdon BETWEEN '$from_date' and '$to_date' and admin != 2 order by id desc");
