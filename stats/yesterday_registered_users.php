			...
			<table class="overflow-y">
				...
				<tbody>
					...
					//////////////////////////END////////////////////////
						...
						$registered_users = mysql_query("SELECT * FROM registration WHERE createdon BETWEEN '".date("Y-m-d", $start24hrs)." 00:00:00' and '".date("Y-m-d")." 00:00:00' and admin != 2 order by id desc");
