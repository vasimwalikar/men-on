            ...
            <div class="templatemo-content-widget white-bg col-2">
             ...
             <!-- <div class="square"></div>-->
			  ...
			  <?php
					...
					$racelog_today = mysql_query("SELECT * FROM racelog WHERE numplayers=2 order by raceid desc ");
					...
					$result = mysql_query("SELECT count(raceid) as total from racelog where numplayers=2");
				...
				<div class="row form-group">
					<div class="col-lg-12 form-group" style="padding-left: 25px; padding-right: 25px; margin-top: 200px;">  
						...
						<div class="margin-right-15 templatemo-inline-block">
							...
							<input class="form-control" name="from_date" type="text"  data-beatpicker="true"/ value="2014-01-01 00:00:00">  
						</div>
						<div class="margin-right-15 templatemo-inline-block">                      
