          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
             ...
             <!-- <div class="square"></div>-->
              <h2 class="templatemo-inline-block">Yesterday's User Details</h2><hr>
			  <?php
					
					$racelog_today = mysql_query("SELECT * FROM racelog WHERE numplayers=2 AND start ".$last24hrs);
					...
					<div class="col-lg-12 form-group" style="padding-left: 25px; padding-right: 25px; margin-top: 200px;">  
						...
						<div class="col-lg-6 col-md-6 form-group" style="width: 200px;"> 
							...
							<select class="form-control" name="player">
								...
								<option VALUE ="2" <?php echo $Wave_player== '2' ? 'selected': 'selected'; ?>>2-Player</option> 
						...
						<div class="margin-right-15 templatemo-inline-block">
							...
							<input class="form-control" name="from_date" type="text"  data-beatpicker="true"/ value="<?php echo date('Y-m-d',strtotime("-1 days"))." 00:00:00";?>">  
						</div>
						<div class="margin-right-15 templatemo-inline-block">                      
