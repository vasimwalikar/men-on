            ...
            <div class="templatemo-content-widget white-bg col-2">
             ...
             <!-- <div class="square"></div>-->
			  ...
			  <?php
					...
					$racelog_today = mysql_query("SELECT * FROM racelog WHERE numplayers=4 order by raceid desc ");
					...
					$result = mysql_query("SELECT count(raceid) as total from racelog where numplayers=4 ");
